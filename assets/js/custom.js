...
function stripeArea() {
    ...
    for(let i = 1; i <= 60; i ++) {
        ...
        if(i % 5 == 0) {
            createSpanTagForStripe.classList.add('stipe-item' ,'circle');

        } else {
            createSpanTagForStripe.classList.add('stipe-item');
        }
...
function numberArea() {
    let numberAreaParendtElement = document.createElement('div');
    numberAreaParendtElement.classList.add('number-area');
    ...
    for (let i = 1; i <= 12; i++) {
        ...
        numberAreaParendtElement.append(createNumberDive);
    }

    return numberAreaParendtElement;
}
